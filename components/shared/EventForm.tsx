                    ...
                    <FormField control={form.control} name="description" render={({ field }) => (
                        <FormItem className="w-full">
                            <FormControl className="h-72">
                                <Textarea placeholder="Event Description" className="textarea rounded-2xl" {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
                    ...
                    <FormField control={form.control} name="imageUrl" render={({ field }) => (
                        <FormItem className="w-full">
                            <FormControl className="h-64">
                                <FileUploader onFieldChange={field.onChange} setFiles={setFiles} imageUrl={field.value}></FileUploader>
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
                        ...
                        <FormItem className="w-full">
                            <FormControl>
                                <div className="flex-center h-[54px] w-full overflow-hidden rounded-full bg-grey-50 px-4 py-2">
                                    ...
                                    <Input type="number" placeholder="Event Price" className="p-regular-16 border-0 bg-grey-50 outline-offset-0 focus:bottom-0 focus-visible:ring-0 focus-visible:ring-offset-0" {...field} />
